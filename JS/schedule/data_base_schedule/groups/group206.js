export const schedule206 = [
    {
        day1:
            {
                lesson1: "Теория вероятностей и мат.статистика, \n" +
        ...
        day3:
            {
                ...
                lesson2:"Основы правоведения и противодействия коррупции (2-10нед.) списки студентов," +
                    "Экономическая культура (11-18нед.)",
                lesson3:"Основы разработки информационных систем  Java, Барков Д., \n" +
                    "в 1303",
                lesson4:"",
    ...
    },
    {
        day5:
            {
                lesson1: "Основы разработки информационных систем  Java, Барков Д.,в 1310",
